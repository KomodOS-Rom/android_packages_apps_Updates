...
import org.komodo.ota.UpdaterApplication;
import org.komodo.ota.activities.UpdaterActivity;
import org.komodo.ota.misc.Constants;
import org.komodo.ota.misc.State;
import org.komodo.ota.misc.UpdateInfo;
import org.komodo.ota.requests.UpdatesJsonObjectRequest;
import org.komodo.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "org.komodo.ota.action.UPDATE_CHECK_FINISHED";
